...
exports.GiftCardClient = void 0;
const google_auth_library_1 = require("google-auth-library");
__exportStar(require("./types/retail/gift-card/index.js"), exports);
class GiftCardClient {
    ...
    classUrl = `${this.baseUrl}/giftCardClass`;
    objectUrl = `${this.baseUrl}/giftCardObject`;
